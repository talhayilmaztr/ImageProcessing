        ...
        while cap.isOpened():
            ...
            for i, group in enumerate(groups):
                if len(group) > 1:  # Only draw groups with more than one rectangle
                    ...
                    if blue_count == 1 and red_count == 2 and green_count == 2:
                        city_name = "A Sehri"
                        rectangle_color = (255, 0, 0)  # Blue for A and B
                    elif blue_count == 1 and red_count == 1 and green_count == 3:
                        city_name = "B Sehri"
                        rectangle_color = (255, 0, 0)  # Blue for A and B
                    elif blue_count == 1 and red_count == 3 and green_count == 1:
                        city_name = "C Sehri"
